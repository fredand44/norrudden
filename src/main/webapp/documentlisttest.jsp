...
try
{
	...
	stringBuffer.append( "<td colspan=\"3\" valign=\"top\" class=\"font_verdana_12_black\">");
	stringBuffer.append( "Här listas viktiga dokument som är uppladdade av styrelsen och som kan vara intressanta för medlemmar.<br/><br/>" );
	...
	if( documents.size() > 0 )
	{
		...
		for(int i = 0; i < documents.size(); i++)
		{
			...
			{
				stringBuffer.append( "<a href=\"/pdfdocumentservlet?documentid=");
			}
			else if( document.getName().endsWith(".doc") )
			{
				stringBuffer.append( "<a href=\"/worddocumentservlet?documentid=");
			}
			else
			{
